...
namespace Lab13{
    internal class Circle:Shape, IScaleable {
        ...
        public int Radius
        {
            ...
            set 
            {
                ActionOn?.Invoke(this, new EventArgs());
                // if(value > 0)
                    this.radius = value;
                // else
        ...
        public void OnRadiusChanged(object sender, EventArgs args)
        {
            Console.WriteLine("Изменение радиуса выполнено");
        }
    }
}